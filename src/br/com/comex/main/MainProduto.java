...
public class MainProduto {
	...
	// Produto produto1 = new Produto(24,"Notebook Samsung",3250.00,1, new Categoria( "informatica", StatusDaCategoria.ATIVA));
	...
	// System.out.println("--------------------------------------------------------");
	 ...
	 ProdutoIsento produto2 = new ProdutoIsento(24,"Per",35.00,1, new Categoria( "informatica", StatusDaCategoria.INATIVA));
	 
	 produto2.setCategoriaProduto(new Categoria( "Livros", StatusDaCategoria.ATIVA));
	...
	// Produto produto3 = new Produto(24,"MONITOR DELL",1000, 2, new Categoria( "informatica", StatusDaCategoria.ATIVA));
